...
<body>
    <center>
       ...
       <img src="../img1/bloodadmin.jpg" width="300" height="200"><br>
        <p>Welcome to the BBNS Admin Registration Form</p>

    
        <form name="adminform" method="post" onsubmit="return Validation()" enctype="multipart/form-data">
